...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'CBT_scheduled', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=375)),
            ('assessment', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ...
        db.send_create_signal(u'CBT', ['scheduled'])


    def backwards(self, orm):
        # Deleting model 'scheduled'
        db.delete_table(u'CBT_scheduled')
